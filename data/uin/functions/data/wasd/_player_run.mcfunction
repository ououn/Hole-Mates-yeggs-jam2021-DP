#   .in1    r0 (auto converted from -180~180 to 0~360)
#   .out1   s
#   .out2   w
#   .out3   d
#   .out4   a

scoreboard players operation .in1 temp = .me r0
...
scoreboard players operation .in2 temp = .me x_dlt
scoreboard players operation .in3 temp = .me z_dlt
