execute if data entity @s Inventory[{Slot:4b,id:"minecraft:potion"}] run function game:give_potion
...
execute if score #page value matches 1 run function game:level/level_1/inventory/diary/page_2
execute if score #page value matches 2 unless entity @a[tag=level_1_task_1] run function game:level/level_1/inventory/diary/page_3a
execute if score #page value matches 2 if entity @a[tag=level_1_task_1] run function game:level/level_1/inventory/diary/page_3b
