...
execute if score #page value matches 1 unless entity @a[tag=level_task_1] run function game:level/level_1/inventory/diary/page_2a
execute if score #page value matches 1 if entity @a[tag=level_task_1] run function game:level/level_1/inventory/diary/page_2b
